...
namespace utils {
    ...
    public:
        ...
        static core::YLight& updateLight(const LuaHandler& luaHandler, core::YLight& light, const std::string& updateFunction, float deltaTime);
        ...
        static core::YAmbientLight loadAmbientLightFromTable(const std::string &identifier, const LuaHandler& luaHandler);
